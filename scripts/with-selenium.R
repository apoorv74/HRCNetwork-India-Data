...
# file_path_to_write <- glue::glue("data/date-wise-case-details/{date_selected}.json")
# jsonlite::write_json(x = all_cases_details, path = "{file_path_to_write}", auto_unbox=TRUE)
